...
export default function page() {
  return (
    <div className=" mt-5 md:mt-20 flex flex-col items-center">
      <h1 className="text-center text-2xl text-pink-600 font-bold ">Redeem Request</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 justify-center items-center w-[95vw] pt-6 mx-auto pb-40">
        <div className='w-full border-2 flex flex-col  px-4 border-black rounded-xl'>
          ...
          <h1 className='text-start font-bold text-xl pt-4 text-[#a2225a] '>Redeem By</h1>
          ...
          <div className="action flex  mb-4 mt-2 gap-x-2">
            <button className=' w-fit p-2 bg-transparent border-2 font-bold text-green-600 flex justify-center rounded-2xl border-green-600'>Redeemed</button>
